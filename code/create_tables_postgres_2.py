...
create_table += "created_at TIMESTAMP)"
...
create_table += "(id SERIAL PRIMARY KEY, "
create_table += "template_name VARCHAR, "
...
create_table += "(id SERIAL PRIMARY KEY, "
create_table += "template_id VARCHAR, "
create_table += "description VARCHAR, "
create_table += "city VARCHAR, "
create_table += "start_date VARCHAR, "
...
create_table += "completed BOOLEAN, "
create_table += "completion_date VARCHAR, "
create_table += "checked_off_by INTEGER, "
create_table += "instructor_id INTEGER, "
create_table += "task_notes TEXT)"
...
SQLExecute = "INSERT INTO sets"
SQLExecute += "(template_id, description, city, start_date, employee_id, manager_id, buddy_id, allocated) VALUES"
SQLExecute += "(5, 'Ring-bearer quest for a Hobbit', 'Middle-Earth', '21-08-2019', 28, 22, 26, FALSE)"
cursor.execute(SQLExecute)
#connection.commit()
